...
app.get("/", (req, res) => res.json({ status: "IMPROLUX Bot activo 🟢", version: "4.5.1-presup-promedio" }));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => {
  console.log(`IMPROLUX Bot v4.5.1-presup-promedio corriendo en puerto ${PORT}`);
