...
app.get("/", (req, res) => res.json({ status: "IMPROLUX Bot activo 🟢", version: "4.3.8-ingresos-faltantes" }));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => {
  console.log(`IMPROLUX Bot v4.3.8-ingresos-faltantes corriendo en puerto ${PORT}`);
