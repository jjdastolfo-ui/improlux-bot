...
app.get("/", (req, res) => res.json({ status: "IMPROLUX Bot activo 🟢", version: "4.6.1-bienes-valuacion" }));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => {
  console.log(`IMPROLUX Bot v4.6.1-bienes-valuacion corriendo en puerto ${PORT}`);
