...
app.get("/", (req, res) => res.json({ status: "IMPROLUX Bot activo 🟢", version: "4.19.1-chat-registra" }));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => {
  console.log(`IMPROLUX Bot v4.19.1-chat-registra corriendo en puerto ${PORT}`);
