...
- ordenes_trabajo(id, numero, anio, lote, titulo, ciclo, hectareas, estado 'PLANIFICADA'/'EN_EJECUCION'/'EJECUTADA', total_planificado, total_ejecutado). Un lote multi puede venir como "A + B + C".
...
- Para insumos faltantes de un año: sumá cantidad de orden_items (tipo='INSUMO', ejecutado=0, con producto_id) de las órdenes de ese año y restá stock_productos.cantidad.
...
app.get("/", (req, res) => res.json({ status: "IMPROLUX Bot activo 🟢", version: "4.4.2-bot-consulta" }));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => {
  console.log(`IMPROLUX Bot v4.4.2-bot-consulta corriendo en puerto ${PORT}`);
