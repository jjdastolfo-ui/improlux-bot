...
app.get("/", (req, res) => res.json({ status: "IMPROLUX Bot activo 🟢", version: "4.19.0-inversor-cash" }));

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => {
  console.log(`IMPROLUX Bot v4.19.0-inversor-cash corriendo en puerto ${PORT}`);
